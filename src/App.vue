      ...
      <div class="hero-body">
        <div class="container">
          <div class="th-logo has-text-centered">
            <img src="https://cdn.treehouseinternetgroup.com/cms_images/30/DryGuys_WebsiteLogo-(3).png" alt="" style="width:250px">
          </div>
 ...
 <!----------------- Modal ---------------->    
        ...
        <modal name="output" :height="500">
          ...
          <div class="gif-box level-item has-text-centered">
            <ul>
              <li>1. Place cursor at the top-left corner of Dry Guys Basement Systems logo and click & drag to bottom-right corner of the disclaimer</li>
    ...
    <footer class="" id="footer">
        <div class="container">
            <div class="content has-text-centered">
                <p>
                    &copy;2022 Dry Guys Basement Systems
                </p>
            </div>
        </div>
    </footer>
